...
const Header = () => {
    ...
    return (
        <section className="fixed z-10 w-full pt-2">
                    ...
                    <div className="dropdown dropdown-end">
                        <label tabIndex={0} className="btn btn-ghost btn-circle avatar">
                            <div className="w-10 rounded-full">
                                <img alt="Tailwind CSS Navbar component" src="https://www.itvanilla.com/wp-content/uploads/2023/01/DSC00171-01-350x350.jpg" />
                            </div>
                        </label>
